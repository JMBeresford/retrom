...
## [Unreleased]
## [0.3.3](https://github.com/JMBeresford/retrom/compare/retrom-v0.3.2...retrom-v0.3.3) - 2024-11-07

### Fixes
- group platforms by name in side bar

    When a platform is present in two content directories, all games
    from both directories are now shown under a single platform entry.

    fixes [#169](https://github.com/JMBeresford/retrom/pull/169)
