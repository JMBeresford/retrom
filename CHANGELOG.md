...
## [Unreleased]
## [0.7.31](https://github.com/JMBeresford/retrom/compare/v0.7.30...v0.7.31) - 2025-07-30

### Bug Fixes
- controller binding menu tweaks

    The menu UI for binding in-game controls has been
    tweaked for better visual clarity
