...
pub fn saves_router(db_pool: DbPool, config_svc_client: ConfigServiceClient<Channel>) -> axum::Router {
    let saves_service_v1 =
        SavesServiceServer::new(SavesServiceHandlers::new(db_pool.clone(), config_svc_client));
