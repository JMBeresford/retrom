...
pub fn metadata_router(
    ...
    use retrom_codegen::retrom::{
        ...
        services::metadata::v1::metadata_service_server::MetadataServiceServer as MetadataServiceServerV1,
    };

    let handlers = MetadataServiceHandlers::new(
        db_pool,
        igdb_client,
        steam_provider,
        media_cache,
    ...
    let metadata_service = MetadataServiceServer::new(handlers.clone());
    let metadata_service_v1 = MetadataServiceServerV1::new(handlers);
